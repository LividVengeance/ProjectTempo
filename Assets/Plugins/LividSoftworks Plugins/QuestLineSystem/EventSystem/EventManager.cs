...
public class EventManager : MonoBehaviour
{
    ...
    // Fire off event with given event event data object
    ...
    // Fire off given templated event type with given event params
    ...
    // Used to bind function pointer to the templated event type
